...
public class Tests {
	...
	public void setup() {
		...
		this.world = new World(100.0, 100.0, map, random);
	}
	...
	public void testConstructorLegalCase2() throws ModelException {
		Worm testWorm = new Worm(100,1,-3*Math.PI,1.9,"Test \' \" ",true,world);
		assertEquals(100,testWorm.getCoordinateX(),EPS);
	...
	public void testConstructorLegalCase3() throws ModelException {
		Worm testWorm = new Worm(2,50,3*Math.PI,20,"James'OhAre \" ",true,world);
		assertEquals(2,testWorm.getCoordinateX(),EPS);
		assertEquals(50,testWorm.getCoordinateY(),EPS);
		assertEquals(Math.PI,testWorm.getDirection(),EPS);
	...
	public void testConstructorLegalCaseNameNumber() throws ModelException{
		new Worm(10.0,5.0,Math.PI,1.0,"James 5",true,world);
	}
	...
	public void testChangeRadiusIllegalCase() {
		Worm testWorm = new Worm(10.0,40.0,Math.PI,1,"Bob",true,world);
		testWorm.setRadius(Integer.MAX_VALUE);
	}
	
	@Test
	public void testTurnLegalCase1(){
		Worm testWorm = new Worm(10.0,78.0,Math.PI,1,"Bob",true,world);
	...
	public void testTurnLegalCase2(){
		...
		int actionPoints = (int) (testWorm.getMaximumActionPoints()- (Math.round((60*Math.PI/2)/(2*Math.PI))));
		assertEquals(actionPoints ,testWorm.getActionPoints());
	}
...
//		Worm testWorm = new Worm(10.0,5.0,Math.PI*3/5,1,"Bob",true,world);
//		testWorm.move();
//		assertEquals(testWorm.getCoordinateX(), 10+0.5*testWorm.getRadius()*Math.cos(Math.PI*3/5), EPS);
//		assertEquals(testWorm.getCoordinateY(), 5+0.5*testWorm.getRadius()*Math.sin(Math.PI*3/5), EPS);
//		assertEquals(testWorm.getActionPoints(), testWorm.getMaximumActionPoints()-((int) (Math.abs(Math.cos(Math.PI*3/5)) + 4*Math.abs(Math.sin(Math.PI*3/5)))));
//	}
//	
//	@Test(expected=ModelException.class)
//	public void testMoveIllegalCaseCannotMove() throws ModelException {
//		Worm testWorm = new Worm(10.0,5.0,0,1,"Bob",true,world);
//		while(testWorm.canMove(1, testWorm.getDirection())) {
//			testWorm.move();
//		}
//	}
	...
	public void testJumpLegalCase() {
		Worm testWorm = new Worm(12.0,11.0,Math.PI/4,1,"Bob",true,world);
		world.addAsGameObject(testWorm);
		testWorm.fall();
		testWorm.jump(Math.pow(10, -4));
		System.out.println(testWorm.getCoordinateY());
		assertEquals(testWorm.getCoordinateX(),
			12.0 + (Math.pow((0.5*(5*testWorm.getMaximumActionPoints()+testWorm.getMass()*9.80665))/testWorm.getMass(), 2)
					*Math.sin(2*testWorm.getDirection())/9.80665),EPS);
		assertEquals(testWorm.getActionPoints(),0);
	}
//	
//	@Test
//	public void testJumpLegalCaseRandomDirection() {
//		Worm testWorm = new Worm(10.0,10.0,(3.0/5.0)*Math.PI,1,"Bob",true,world);
//		testWorm.jump(Math.pow(10,-4));
...
//		Worm testWorm = new Worm(10.0,-5.0,Math.PI*(-3.0/5.0),1,"Bob",true,world);
//		testWorm.jump();
//		assertEquals(testWorm.getActionPoints(),0);
//	}
//	
...
//		Worm testWorm = new Worm(10.0,-5.0,(3.0/2.0)*Math.PI,1,"Bob",true,world);
//		testWorm.jump();
//		assertEquals(testWorm.getActionPoints(),0);
//	}
}
